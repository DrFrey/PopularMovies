...
public final class NetworkUtilities {
    private final static String POPULAR_URL = "http://api.themoviedb.org/3/movie/popular?api_key=";
    private final static String TOP_URL = "http://api.themoviedb.org/3/movie/top_rated?api_key=";
